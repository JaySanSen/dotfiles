...
back                                               <a-s-left> button=4 clickcount=1 modifiers=0
backgroundtasks
bash.addreplaction
bash.newbashscript
bash.repl.group
...
console.tableresult.viewastransposedtable
...
django.runmanagetaskaction                         <a-c-r>
...
forward                                            <a-s-right> button=5 clickcount=1 modifiers=0
...
productivityguide
profiler
projectviewchangeview                              <a-s-1> <a-f1>
...
publishingcontextmenuaction
publishingcopylinkaction
publishingmanageaccessrightsaction
publishingopenlinkaction
publishingsignoutaction
publishingupdateaction
publishjupyternotebookaction
